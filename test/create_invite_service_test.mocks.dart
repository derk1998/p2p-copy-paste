...
// in p2p_copy_paste/test/create_invite_service_test.dart.
...
import 'package:p2p_copy_paste/lifetime.dart' as _i7;
...
/// A class which mocks [LifeTime].
///
/// See the documentation for Mockito's code generation for more information.
class MockLifeTime extends _i1.Mock implements _i7.LifeTime {
  MockLifeTime() {
    _i1.throwOnMissingStub(this);
  }
  ...
  @override
  void expire() => super.noSuchMethod(
        Invocation.method(
          #expire,
          [],
        ),
