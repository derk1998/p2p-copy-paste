...
import 'package:p2p_copy_paste/lifetime.dart' as _i11;
import 'package:p2p_copy_paste/models/invite.dart' as _i12;
...
import 'package:p2p_copy_paste/services/create_invite.dart' as _i10;
import 'package:p2p_copy_paste/services/file.dart' as _i7;
import 'package:p2p_copy_paste/services/join_connection.dart' as _i13;
import 'package:p2p_copy_paste/services/join_invite.dart' as _i14;
...
class MockINavigator extends _i2.Mock implements _i3.INavigator {
  MockINavigator() {
...
///
/// See the documentation for Mockito's code generation for more information.
class MockIAuthenticationService extends _i2.Mock
...
///
/// See the documentation for Mockito's code generation for more information.
class MockIFileService extends _i2.Mock implements _i7.IFileService {
  MockIFileService() {
    _i2.throwOnMissingStub(this);
  }

  @override
  _i5.Future<String> loadFile(String? location) => (super.noSuchMethod(
        Invocation.method(
          #loadFile,
          [location],
        ),
...
class MockICreateConnectionService extends _i2.Mock
    implements _i9.ICreateConnectionService {
  MockICreateConnectionService() {
    _i2.throwOnMissingStub(this);
  }

  @override
  _i5.Future<void> startNewConnection() => (super.noSuchMethod(
        Invocation.method(
          #startNewConnection,
          [],
        ),
...
class MockICreateInviteService extends _i2.Mock
    implements _i10.ICreateInviteService {
  ...
  _i5.Future<void> create(
    void Function(_i10.CreateInviteUpdate)? onCreateInviteUpdate,
    WeakReference<_i11.LifeTime>? lifeTime,
  ) =>
      (super.noSuchMethod(
        Invocation.method(
          #create,
  ...
  @override
  _i5.Future<bool> accept(_i12.Invite? invite) => (super.noSuchMethod(
        Invocation.method(
          #accept,
          [invite],
        ),
  ...
  @override
  _i5.Future<bool> decline(_i12.Invite? invite) => (super.noSuchMethod(
        Invocation.method(
          #decline,
          [invite],
        ),
...
class MockIJoinConnectionService extends _i2.Mock
    implements _i13.IJoinConnectionService {
  MockIJoinConnectionService() {
    _i2.throwOnMissingStub(this);
  }

  @override
  _i5.Future<void> joinConnection(String? connectionId) => (super.noSuchMethod(
        Invocation.method(
          #joinConnection,
          [connectionId],
        ),
...
class MockIJoinInviteService extends _i2.Mock
    implements _i14.IJoinInviteService {
  ...
  _i5.Future<void> join(
    _i12.Invite? invite,
    void Function(_i14.InviteStatus)? onInviteStatusChangedListener,
  ) =>
      (super.noSuchMethod(
        Invocation.method(
          #join,
